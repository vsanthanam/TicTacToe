...
final class LoggedOutViewController: UIViewController, LoggedOutPresentable, LoggedOutViewControllable {
    ...
    override func viewDidLoad() {
        ...
        let playerFields = self.buildPlayerFields()
        self.buildLoginButton(withPlayer1Field: playerFields.player1Field, player2Field: playerFields.player2Field)
    ...
    @objc private func didTapLoginButton() {
        ...
        self.listener?.tappedLogin(withPlayer1Name: self.player1Field?.text, player2Name: self.player2Field?.text)
